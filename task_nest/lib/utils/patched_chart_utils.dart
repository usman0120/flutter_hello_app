...
// This is a patched version of Utils class from fl_chart 0.61.0
// that removes the deprecated MediaQuery.boldTextOverride usage

class PatchedChartUtils {
  factory PatchedChartUtils() {
    return _singleton;
  }

  PatchedChartUtils._internal();
  static PatchedChartUtils _singleton = PatchedChartUtils._internal();

  @visibleForTesting
  static void changeInstance(PatchedChartUtils val) => _singleton = val;
  ...
  TextStyle getThemeAwareTextStyle(
    ...
    // Remove the deprecated MediaQuery.boldTextOverride usage
